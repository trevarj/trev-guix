...
(define-public root-uuid
  "4b3be666-93bc-49e1-b275-cfccbc9c2729")
(define-public efi-uuid
  "4B66-8689")
(define-public swap-uuid
  "f95483f8-7921-4f0f-b509-2752e67b7a2f")
...
(define-public %stinkpad
  (operating-system
    ...
    (users (cons (user-account
                   ...
                   (supplementary-groups '("trev" "wheel"
                                           "netdev"
                                           "kvm"
                                           "tty"
                                           "input"
    ...
    (services
     (append (modify-services %desktop-services
               ...
               (sane-service-type _ =>
                                  (sane-configuration (backends (list
                                                                 sane-backends
                                                                 sane-airscan)))))
             (list
              ...
              (service tor-service-type
                       (tor-configuration (transport-plugins (list (tor-transport-plugin
                                                                    (protocol
                                                                     "webtunnel")
                                                                    (program (file-append
                                                                              lyrebird
